...
//address Table:
#define NVMEM_AD_GLOBAL_RED		1
#define NVMEM_AD_GLOBAL_GREEN	2
#define NVMEM_AD_GLOBAL_BLUE	3
#define NVMEM_AD_ROWS_VISIBLE	4
#define NVMEM_AD_OVERSCAN		5
#define NVMEM_AD_PICTURE_START	6
