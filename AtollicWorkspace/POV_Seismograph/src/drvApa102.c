...
//	Old, blocking approach without DMA
...
//	{
//		while(SPI_GetTransmissionFIFOStatus(SPI1) != SPI_TransmissionFIFOStatus_Empty);
//		SPI_SendData8(SPI1, 0xE0 |(leds[i].global & 0x1F));	//global
//		SPI_SendData8(SPI1, leds[i].blue);
//		SPI_SendData8(SPI1, leds[i].green);
//		SPI_SendData8(SPI1, leds[i].red);
//	}
//	//end-frame
//	while(SPI_GetTransmissionFIFOStatus(SPI1) != SPI_TransmissionFIFOStatus_Empty);
