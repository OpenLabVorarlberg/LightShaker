...
ErrorStatus RTC_SetTime(uint32_t RTC_Format, RTC_TimeTypeDef *RTC_TimeStruct) {
	...
	if (RTC_Format != RTC_Format_BIN) {
		...
		tmpreg = (uint32_t) (((uint32_t) RTC_ByteToBcd2(
...
void RTC_GetTime(uint32_t RTC_Format, RTC_TimeTypeDef *RTC_TimeStruct) {
	...
	RTC_TimeStruct->RTC_Hours = (uint8_t) ((tmpreg & (RTC_TR_HT | RTC_TR_HU))
			>> 16);
...
ErrorStatus RTC_SetDate(uint32_t RTC_Format, RTC_DateTypeDef *RTC_DateStruct) {
	...
	if ((RTC_Format == RTC_Format_BIN)
		...
		RTC_DateStruct->RTC_Month = (RTC_DateStruct->RTC_Month
				& (uint32_t) ~(0x10)) + 0x0A;
	}
	if (RTC_Format == RTC_Format_BIN) {
...
void RTC_GetDate(uint32_t RTC_Format, RTC_DateTypeDef *RTC_DateStruct) {
	...
	/* Fill the structure fields with the read parameters */
	RTC_DateStruct->RTC_Year = (uint8_t) ((tmpreg & (RTC_DR_YT | RTC_DR_YU))
			>> 16);
	RTC_DateStruct->RTC_Month = (uint8_t) ((tmpreg & (RTC_DR_MT | RTC_DR_MU))
			>> 8);
...
void RTC_SetAlarm(uint32_t RTC_Format, uint32_t RTC_Alarm,
	...
	if (RTC_Format != RTC_Format_BIN) {
		...
		tmpreg = (((uint32_t) RTC_ByteToBcd2(
...
void RTC_GetAlarm(uint32_t RTC_Format, uint32_t RTC_Alarm,
	...
	RTC_AlarmStruct->RTC_AlarmTime.RTC_Hours = (uint32_t) ((tmpreg
			& (RTC_ALRMAR_HT |
			RTC_ALRMAR_HU)) >> 16);
	RTC_AlarmStruct->RTC_AlarmTime.RTC_Minutes = (uint32_t) ((tmpreg
			& (RTC_ALRMAR_MNT |
			RTC_ALRMAR_MNU)) >> 8);
	RTC_AlarmStruct->RTC_AlarmTime.RTC_Seconds = (uint32_t) (tmpreg
			& (RTC_ALRMAR_ST |
			RTC_ALRMAR_SU));
	RTC_AlarmStruct->RTC_AlarmTime.RTC_H12 =
			(uint32_t) ((tmpreg & RTC_ALRMAR_PM) >> 16);
	RTC_AlarmStruct->RTC_AlarmDateWeekDay = (uint32_t) ((tmpreg
			& (RTC_ALRMAR_DT | RTC_ALRMAR_DU)) >> 24);
	RTC_AlarmStruct->RTC_AlarmDateWeekDaySel = (uint32_t) (tmpreg
			& RTC_ALRMAR_WDSEL);
...
void RTC_AlarmSubSecondConfig(uint32_t RTC_Alarm,
		uint32_t RTC_AlarmSubSecondValue, uint8_t RTC_AlarmSubSecondMask) {
	uint32_t tmpreg = 0;
	...
	tmpreg = (uint32_t) (((uint32_t) (RTC_AlarmSubSecondValue))
			| ((uint32_t) (RTC_AlarmSubSecondMask) << 24));
...
void RTC_GetTimeStamp(uint32_t RTC_Format, RTC_TimeTypeDef *RTC_StampTimeStruct,
	...
	RTC_StampTimeStruct->RTC_Hours = (uint8_t) ((tmptime
			& (RTC_TR_HT | RTC_TR_HU)) >> 16);
	RTC_StampTimeStruct->RTC_Minutes = (uint8_t) ((tmptime
			& (RTC_TR_MNT | RTC_TR_MNU)) >> 8);
	RTC_StampTimeStruct->RTC_Seconds = (uint8_t) (tmptime
			& (RTC_TR_ST | RTC_TR_SU));
	RTC_StampTimeStruct->RTC_H12 = (uint8_t) ((tmptime & (RTC_TR_PM)) >> 16);

	/* Fill the Date structure fields with the read parameters */
	RTC_StampDateStruct->RTC_Year = 0;
	RTC_StampDateStruct->RTC_Month = (uint8_t) ((tmpdate
			& (RTC_DR_MT | RTC_DR_MU)) >> 8);
	...
	if (RTC_Format == RTC_Format_BIN) {
		...
		RTC_StampTimeStruct->RTC_Hours = (uint8_t) RTC_Bcd2ToByte(
				RTC_StampTimeStruct->RTC_Hours);
		RTC_StampTimeStruct->RTC_Minutes = (uint8_t) RTC_Bcd2ToByte(
				RTC_StampTimeStruct->RTC_Minutes);
		RTC_StampTimeStruct->RTC_Seconds = (uint8_t) RTC_Bcd2ToByte(
				RTC_StampTimeStruct->RTC_Seconds);

		/* Convert the Date structure parameters to Binary format */
		RTC_StampDateStruct->RTC_Month = (uint8_t) RTC_Bcd2ToByte(
				RTC_StampDateStruct->RTC_Month);
		RTC_StampDateStruct->RTC_Date = (uint8_t) RTC_Bcd2ToByte(
				RTC_StampDateStruct->RTC_Date);
		RTC_StampDateStruct->RTC_WeekDay = (uint8_t) RTC_Bcd2ToByte(
				RTC_StampDateStruct->RTC_WeekDay);
	}
}
...
ITStatus RTC_GetITStatus(uint32_t RTC_IT) {
	...
	enablestatus = (uint32_t) ((RTC->CR & RTC_IT)
